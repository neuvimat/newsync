...
/**
 * Removes all iterable properties from an object as a side effect (does not create a new object). Does not check for own
 * properties, if you need that, {@link clearOwn}.
 * @param object
 * @return {*}
 */
...
// todo: move merging from client/server to containers
