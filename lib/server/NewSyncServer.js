...
export class NewSyncServer {
  ...
  constructor(driver, coder, dictionary) {
    this.driver = driver
    this.dict = this._setUpDictionary(dictionary);
    this.coder = coder
    this.containers = {}
    this._interval = null
    this.clients = {}
   ...
   * @param client {AbstractClientModel} client that sent the message
   */
  ...
  /**
   * Extract events from the incoming message and handle them
  ...
  /**
   * Extract user messages from the incoming message and handle them
   * @param message {object}
   * @param client {AbstractClientModel}
   */
  ...
  /**
   * Extract commands from the incoming message and handle them
   * @param message {object}
   * @param client {AbstractClientModel}
   */
  ...
  /**
   * If no dictionary is specified, automatically create a fake dictionary that does nothing (i.e. do not use
   * dictionary)
  ...
  sync() {
    ...
    for (const c of clientsKeys) {
      ...
      client.clearPersonalizedMessages()
    }
  ...
  /**
   * Send the specified message (an JS object; and NOT a user message as in user event or user message) to all
  ...
  /**
   * Send a user message to specified client
   * @param client {AbstractClientModel}
   * @param message
   */
  ...
  /**
   * Send an array of user messages to specified client
   * @param client {AbstractClientModel}
   * @param messages
   */
  ...
  /**
   * Send user messages to specified client
   * @param client {AbstractClientModel}
   * @param messages
   */
  ...
  /**
   * Send a user message to all clients
   * @param message
   */
  ...
  /**
   * Send an array of user messages to all clients
   * @param messages
   */
  ...
  /**
   * Send an event to specified client
   * @param client {AbstractClientModel}
   * @param eventName {string}
   * @param args {...*}
   */
  ...
  /**
   * Send an array of events to specified client
   * @param client {AbstractClientModel}
   * @param events
   */
  ...
  /**
   * Send events to specified client
   * @param client {AbstractClientModel}
   * @param events
   */
  ...
  /**
   * Send an array of events to clients
   * @param events
   */
