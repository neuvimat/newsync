...
export class NeuSyncServer {
  static clientId = 0
  static dictionary

  get _d() {return NeuSyncServer.dictionary}

  constructor(driver, coder) {
    NeuSyncServer.dictionary = new LongKeyDictionary()
    this.driver = driver
    this.coder = coder
    this.containers = {}
    this._interval = null
    ...
    this.driver.neuSync = this
    this.coder.neuSync = this
  }
  ...
  addClient(...args) {
    const id = NeuSyncServer.clientId++
    this.clients[id] = this.driver.addClient(id, ...args)
